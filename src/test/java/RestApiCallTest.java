...
public class RestApiCallTest {
  ...
  public void testPingOk() {
    String uri="https://webserver-domain.ddns.net:8443/fingerService-api/ping";
  ...
  public void testUserNotFound() {
    String uri ="https://webserver-domain.ddns.net:8443/fingerService-api/search?user_id=123456";
    JSONObject resp = RestApiCall.INSTANCE.getMethod(uri);
